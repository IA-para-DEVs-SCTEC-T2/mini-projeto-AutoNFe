...
pytest -v src/tests --cov=src/agents --cov=src/database --cov-report=term-missing
```
...
Para entender a organização de pastas e arquivos, consulte a [documentação da estrutura](.Kiro/steering/structure.md).
