...
from agents.agent1_leitura import Emitente as EmitLeitura
from agents.agent1_leitura import Destinatario as DestLeitura
from agents.agent1_leitura import ResultadoLeitura
